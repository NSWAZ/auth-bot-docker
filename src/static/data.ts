...
export const announcementData = {
  nis: {
    guildType: "nis" as const,
    channelName: "안내",
    msg: DiscordHandler.returnAnnouncementMsg().nisMsg,
  },
  recruit: {
...
export const terms = {
  0: {
    message: "1. 저희 코퍼레이션은 수평적이고 자유로운 소통을 위해 **반말 사용을 기본**으로 합니다. (물론 존댓말이 편하시다면 사용하셔도 무방합니다.)",
    type: "반말 사용",
  },
  1: {
    message: "2. 또한 PvP를 지향하는 전투 그룹입니다. 꼽의 방향성에 맞춰 **최소한의 PvP 활동에 참여**하셔야 합니다.",
    type: "최소한의 PvP 활동",
  }
}
